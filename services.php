     ...
     <div class="row justify-content-center">
       <div class="col-12 col-md-10 col-lg-7">
         ...
         <div class="section-heading text-center">
           ...
           <p class="text-white d-none d-sm-block mt-4">We have a wonderfull team of wonderfull persons with great
             personnality and great integrity, take a tour to see them below.</p>
         </div>
       </div>
     </div>
     <div class="row">
     ...
     <div class="row justify-content-center">
       <div class="col-12 col-lg-10">
         ...
         <div class="section-heading text-center m-0">
           ...
           <p class="text-white d-none d-sm-block mt-4">Our mission is to make sure that opportunity to be part of our
             community should rip benefit that comes with it. Such as personal grow, be educated in financial literacy,
             etc.</p>
