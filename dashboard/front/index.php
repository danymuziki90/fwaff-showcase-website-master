    ...
    <nav class="navbar navbar-expand-lg navbar-landing navbar-light fixed-top" id="navbar">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class="">
            <a href="apps-nft-explore.html" class="btn btn-danger">Sign In <i
          ...
          <div class="col-lg-8 col-sm-10">
            <div class="text-center">
              ...
              <p class="lead text-white-50 lh-base mb-4 pb-2">Can artwork be NFT? NFTs (non-fungible tokens) are
                one-of-a-kind digital assets. Given they're digital in nature, can physical works of art be turned into
                NFTs?.</p>

              <div class="hstack gap-2 justify-content-center">
                <a href="apps-nft-create.html" class="btn btn-primary">Get Started <i
                    class="ri-arrow-right-line align-middle ms-1"></i></a>
          ...
          <div class="col-lg-8">
            <div class="text-center mb-5">
              ...
              <p class="text-muted">The process of creating an NFT may cost less than a dollar, but the process of
                selling it can cost up to a thousand dollars. For example, Allen Gannett, a software developer.</p>
            </div>
          </div><!-- end col -->
        </div><!-- end row -->
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8">
            <div class="text-center mb-5">
              ...
              <p class="text-muted">A non-fungible token is a non-interchangeable unit of data stored on a blockchain, a
                form of digital ledger, that can be sold and traded.</p>
            </div>
          </div><!-- end col -->
        </div><!-- end row -->
          ...
          <div class="col-sm-6">
            ...
            <div>
              <p class="copy-rights mb-0">
                ...
                </script> © Paywell - All Rights Reserved
              </p>
            </div>
          </div>
          <div class="col-sm-6">
